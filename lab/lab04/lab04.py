...
def buy(required_fruits, prices, total_amount):
    ...
    def add(fruits, amount, cart):
        if fruits == [] and amount == 0:
            ...
            fruit = fruits[0]
            price = prices[fruit] # 从字典中获取该水果的价格
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    # 提取城市的纬度和经度：通过调用 get_lat() 和 get_lon() 函数，分别获取城市的纬度和经度
...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_to_a = distance(temp_city, city_a)
    distance_to_b = distance(temp_city,city_b)
